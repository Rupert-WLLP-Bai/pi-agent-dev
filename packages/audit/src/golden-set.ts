...
因本合同引起的争议，提交重庆仲裁委员会仲裁。`,
  ...
  {
    id: "bench-03",
    description: "50% advance (conflict), 50% penalty (conflict), no termination, Beijing dispute (conflict)",
    text: `电子元件采购合同
...
本合同在双方履行完毕后终止。任何一方违约，守约方有权提前解除合同。`,
  ...
  {
    id: "bench-05",
    description: "25% advance (compliant), 10% penalty (compliant), has termination, Shanghai dispute (conflict)",
    text: `备电设备采购合同
...
争议提交上海仲裁委员会仲裁。`,
  ...
  {
    id: "bench-06",
    description: "0% advance (compliant), 35% penalty (conflict), has termination, Chongqing dispute (compliant)",
    text: `办公用品采购合同
...
争议向重庆人民法院提起诉讼。`,
  ...
  {
    id: "bench-07",
    description: "80% advance (conflict), 5% penalty (compliant), has termination, Chongqing dispute (compliant)",
    text: `大型设备采购合同
...
提交重庆仲裁委员会仲裁。`,
  ...
  {
    id: "bench-08",
    description: "30% advance (boundary), 30% penalty (boundary), has termination, Chongqing dispute",
    text: `物资采购合同
...
向重庆人民法院起诉。`,
  ...
  {
    id: "bench-09",
    description: "31% advance (barely over), 29% penalty (barely under), no termination, no dispute",
    text: `零部件采购合同
...
因本合同争议提交重庆仲裁委员会仲裁。`,
  ...
  {
    id: "bench-12",
    description: "60% advance (conflict), 40% penalty (conflict), no termination, Beijing dispute (conflict) — all 4 rules fire",
    text: `建材采购合同
