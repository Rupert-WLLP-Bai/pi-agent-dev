...
Completed on `main` in commit `2cee58a`. The nine tasks below are implemented; verification evidence is recorded in `CHANGELOG.md` (TypeScript, package tests, Playwright acceptance, and Docker build).
...
- [x] **Step 1: Create a failing workspace-resolution test**
...
- [x] **Step 3: Add the root workspaces and the minimal module**
...
- [x] **Step 3: Implement minimal types and rule**
...
- [x] **Step 3: Implement a narrow, explicit parser**
...
- [x] **Step 3: Create the five MVP tables**
...
- [x] **Step 4: Apply migration and run tests**
...
- [x] **Step 1: Write a no-tool smoke test and a fake-agent unit test**
...
- [x] **Step 3: Implement explicit Pi configuration and allowlisted tools**
...
- [x] **Step 4: Run tests and the manual credential smoke test**
...
- [x] **Step 3: Implement lifecycle-safe dispatching**
...
- [x] **Step 3: Implement routes with Elysia schemas**
...
- [x] **Step 1: Write the failing Playwright acceptance test**
...
- [x] **Step 1: Write a failing health check script**
...
- [x] **Step 3: Implement verification assets**
